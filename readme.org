#+TITLE: ZK-Auctions Toolkit Grant Proposal and Progress Tracking
...
Foundation for sponsoring this project and bringing it into light. Additionally,
we are also thankful to Florian Kerschbaum and Erik-Oliver Blass for providing a
Python 2.7-implementation of the Strain protocol which served as a reference for
...
** Project Details and Motivation <<project_details_and_motivation>>
...
** Milestone 1: Research, Proof-sketching, and Algorithm Design <<milestone-1>>
...
competitiveness will not have an impact on subsequent comparisons.
         ...
         -----
***** $\star$ In [cite:@blass2018strain] <<strain>>,
...
**** DONE Milestone 1: (Sprint 3): Test suite development (cont'd) <<milestone-1-sprint-3>>
...
** Milestone 2: Development <<milestone-2>>
...
- @ndrwnaguib will implement the primitives contained in the
  <<auction-specification-model>> as structs and traits. Initially, they are not expected to be
  located anywhere only until the main skeleton is decided
